    ...
    return (
        <div ref={divModalMenu} className="fixed flex items-center justify-center top-0 left-0 h-full w-full bg-black/50 z-10 backdrop-blur-[1.5px]" style={modalDisplay}>
            <div className="relative p-14 w-[58vw] h-[58vw] bg-100%" style={{backgroundImage:`url(${IMGModalInfo})`}}>
                <button onClick={(() => { setModalDisplay(modalDisplayDefault); dispatch(setInfosModal(false)) })} className="absolute right-[6.5vw] top-[5.4vw] h-[calc(3vw+5px)] w-[calc(3vw+5px)] bg-100% botao-fechar" style={{backgroundImage: `url(${IMGBotaoFechar})`}} />
                <div className="relative h-[47%] w-[90%]">
                    <img src={IMGPasso1} className="relative mr-1 float-left w-[48%] h-[100%] z-[2] drop-shadow-[-3px_-3px_2px_rgba(0,0,0,0.7)]" />
                    ...
                    <hr className="relative top-[-52%] left-[40%] h-1 w-[24vw] bg-[#FFA64D] border-[3.8px] border-[#FFA64D] rounded-md" />
                </div>
                <div className="relative left-[8%] mt-[-20%] h-[47%] w-[90%]">
                    ...
                    <p className="relative top-[5%] font-[hobostd] text-[1.9vw] text-[#FFA54C] text-right"><span>2</span> Escolha um card inimigo para atacar.</p>
                    <hr className="relative bottom-[21%] right-[0%] h-1 w-[24vw] bg-[#FFA64D] border-[3.8px] border-[#FFA64D] rounded-md" />
                </div>
                <div className="relative flex flex-col items-center pt-6 h-[22%] w-[98%]">
                    <p className="relative font-[hobostd] mb-2 text-[1.9vw] text-[#FFA54C] text-center"><span>3</span> O card com o maior valor de atributo vence, elimine os três inimigos para ganhar a rodada.</p>
