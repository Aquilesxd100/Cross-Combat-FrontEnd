        ...
        <div ref={divModalMenu} className="fixed flex items-center justify-center top-0 left-0 h-full w-full bg-black/50 z-10 backdrop-blur-[1.5px]" style={modalDisplay}>
            <div className="relative p-14 w-[58vw] h-[90vh] bg-100%" style={{backgroundImage:`url(${IMGModalInfo})`}}>
                ...
                <div className="relative h-[47%] w-[88%] float-left right-[calc(-3vw+18px)]">
                    <img src={IMGPasso1} className="relative mr-2 float-left w-[48%] h-[100%] z-[2] drop-shadow-[-3px_-3px_2px_rgba(0,0,0,0.7)] off-user-selection" />
                    <p className="relative top-[5%] w-[90%] font-[hobostd] text-[1.75vw] text-[#FFA54C] off-user-selection"><span>1</span> Selecione um<br/>atributo de algum<br/>dos seus cards.</p>
                ...
                <div className="relative float-right mt-[-13%] h-[47%] w-[90%] left-[calc(-3vw+18px)]">
                    <img src={IMGPasso2} className="relative ml-2 float-right w-[48%] h-[100%] z-[2] drop-shadow-[3px_3px_2px_rgba(0,0,0,0.7)] off-user-selection" />
                    <p className="relative top-[39%] font-[hobostd] text-[1.75vw] text-[#FFA54C] text-right off-user-selection"><span>2</span> Escolha um card<br/>inimigo para atacar.</p>
                ...
                <div className="relative left-[5%] top-[-3.5%] flex flex-col items-center pt-6 h-[22%] w-[90%]">
                    <p className="relative font-[hobostd] mb-2 text-[1.75vw] text-[#FFA54C] text-center off-user-selection"><span>3</span> O card com o maior valor de atributo vence,<br/>elimine os três inimigos para ganhar a rodada.</p>
